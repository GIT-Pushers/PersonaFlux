 ...
 * @property {string} [starting_prompt] - Initial interaction prompt (note: keeping typo for DB compatibility)
...
export interface CharacterInsertData {
  ...
  starting_prompt?: string; // Keep the typo to match database schema
